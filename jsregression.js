...
(function (jsr) {
  ...
  var LinearRegression = function (config) {
    ...
    MultiClassLogistic.prototype.initializeModel = function()
    {
        ...
        this.theta = [[-0.03894870929963573, -0.19658330996296342, -0.064955070203532], 
                         [0.03894870929963574, 0.19658330996296342, 0.06495507020353199]];

        this.threshold = [0.42543841443961494, 0.5586122936418346];
        this.cost = [0.6122699592855306, 0.6122699592855306];
        this.dim = 4;
