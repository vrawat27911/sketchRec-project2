...
(function (jsr) {
  ...
  var LinearRegression = function (config) {
    ...
    MultiClassLogistic.prototype.initializeModel = function()
    {

        this.theta = [[-0.06810768261760763, 0.2747052509628823, -0.08206044410852287, -0.06661870856735062],
                            [0.0681076826176076, -0.2747052509628823, 0.08206044410852288, 0.06661870856735061]];

        this.threshold = [0.04204296999588503, 0.44853353783096944];
        this.cost = [0.551433803422927, 0.5514338034229269];
        this.dim = 4;
        this.classes = ['truss','others'];
        ...
        for(var i = 0; i < 2; i++)
        {
            this.logistics[this.classes[i]] = new jsr.LogisticRegression({alpha: this.alpha, lambda: this.lambda, iterations: this.iterations});
            this.logistics[this.classes[i]].theta = this.theta[i];
            this.logistics[this.classes[i]].cost = this.cost[i];
            this.logistics[this.classes[i]].threshold = this.threshold[i];
            this.logistics[this.classes[i]].dim = this.dim;
            this.logistics[this.classes[i]].classes = this.classes;
        }
